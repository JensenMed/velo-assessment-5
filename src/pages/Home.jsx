  ...
  const investmentSteps = [
    {
      ...
      description: 'Connect your cryptocurrency wallet to GoldenProp to start investing.'
    },
    {
      icon: FaStore,
  ...
  const faqSections = [
    {
      ...
      questions: [
        {
          question: "What is GoldenProp?",
          answer: "GoldenProp is an innovative investment project dedicated to real estate. We allow clients to invest as little as $10 in investment properties, with the aim of building up regular income and/or savings."
        },
        {
        ...
        },
        {
          ...
          answer: "The GoldenProp Marketplace is our platform that allows GoldenProp community members to buy and sell NFTs among themselves.  It is the equivalent of a secondary market where investors can buy and sell NFTs among themselves. We may also cooperate with other marketplaces to allow anyone to choose their preferred marketplace."
        },
        {
        ...
        },
        {
          ...
          answer: "GoldenProp uses the most advanced technical means to ensure the confidentiality and security of transactions on the platform. "
        }
      ]
    }
  ];
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
            ...
            <div className="mt-12 lg:mt-0 flex justify-center">
              <div className="bg-white rounded-lg shadow-xl p-8 max-w-sm w-full">
                ...
                <a
                  href="https://discord.gg/GoldenProp"
                  target="_blank"
                ...
                <p className="mt-4 text-sm text-gray-500 text-center">
                  Already a member?{' '}
                  <a href="https://discord.gg/GoldenProp" className="text-indigo-600 hover:text-indigo-500">
                    Sign in
                  </a>
                </p>
              </div>
